...
import { ComposedChart, CartesianGrid, XAxis, YAxis, ResponsiveContainer, Tooltip, Legend, Area, Line, Bar, ReferenceLine, Rectangle } from 'recharts'
                ...
                <Card bg="" text="dark">
                  ...
                  <ResponsiveContainer width={'100%'} height={300}>
                    ...
                    >
                      ...
                      <YAxis allowDataOverflow yAxisId={2} stroke="#ce7e00" ticks={[(last.b1A + last.b2A) / 2]} domain={[-35, 15]} dataKey="b2A" tickFormatter={formatA} orientation='right' />
