            ...
            <Fade in={loaded}>
                <Container className="p-3">
                    <Jumbotron className="text-center" >
                        <h1 className="header"><strong>g NAS</strong> e <strong>SCN Router</strong></h1>
                    </Jumbotron>
                    {!cpu && <Spinner className="ml-3" animation="grow" />}
                    <Fade in={!!cpu}>
                        <CardDeck>
                            {cpu && <Card bg="" text="dark">
                                ...
                                <Card.Body>
                                    ...
                                    <Table hover className="mt-2" size="sm">
                                        <tbody>
                                            {cpu.scnps.map(event => (
                                                <tr><td>{event.split(" ")[2] + " " + event.split(" ")[3].substring(0, 30)}</td></tr>
                                            ))}
                                        </tbody>
                                    </Table>
                                    ...
                                    <Table hover className="mt-2" size="sm">
                                        <tbody>
                                            {cpu.scnuser.map(event => (
                                                <tr><td>{event.split(" ")[0] + " " + event.split(" ")[1]}</td></tr>
                                            ))}
                                        </tbody>
                                    </Table>
                                </Card.Body>
